...
namespace PANSFEM2 {
	...
	//********************det(A)********************
	template<class T>
	T Determinant3(const std::vector<std::vector<T> >& _A) {
		return -_A[2][2] * _A[0][1] * _A[1][0] - _A[2][1] * _A[1][2] * _A[0][0] - _A[0][2] * _A[1][1] * _A[2][0] + _A[2][0] * _A[0][1] * _A[1][2] + _A[2][1] * _A[1][0] * _A[0][2] + _A[0][0] * _A[1][1] * _A[2][2];
	}


	//********************A^-1********************
	template<class T>
	std::vector<std::vector<T> > Inverse3(const std::vector<std::vector<T> >& _A) {
		std::vector<std::vector<T> > B = std::vector<std::vector<T> >(3, std::vector<T>(3));
		B[0][0] = _A[1][1] * _A[2][2] - _A[1][2] * _A[2][1];	B[0][1] = _A[0][2] * _A[2][1] - _A[0][1] * _A[2][2];	B[0][2] = _A[0][1] * _A[1][2] - _A[0][2] * _A[1][1];
		B[1][0] = _A[1][2] * _A[2][0] - _A[1][0] * _A[2][2];	B[1][1] = _A[0][0] * _A[2][2] - _A[0][2] * _A[2][0];	B[1][2] = _A[0][2] * _A[1][0] - _A[0][0] * _A[1][2];
		B[2][0] = _A[1][0] * _A[2][1] - _A[1][1] * _A[2][0];	B[2][1] = _A[0][1] * _A[2][0] - _A[0][0] * _A[2][1];	B[2][2] = _A[0][0] * _A[1][1] - _A[0][1] * _A[1][0];
		return B / Determinant3(_A);
	}
}