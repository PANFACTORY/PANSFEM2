...
int main() {
    ...
    std::vector<Vector<double> > v1 = std::vector<Vector<double> >(x.size(), { 0.0, 1.0, 0.0 });
	std::vector<Vector<double> > v2 = std::vector<Vector<double> >(x.size(), { 0.0, 0.0, 1.0 });
	...
	for (auto element : elements) {
		...
		Matrix<double> Ke;
		BeamLinearIsotropicElastic<double, ShapeFunction2Line, Gauss1Line, Gauss4Square>(Ke, nodetoelement, element, { 0, 1, 2, 3, 4, 5 }, x, v1, v2, 210000.0, 0.3, 1.0, 1.0);
