...
public:
	...
	template<class T>
	Vector<T> ShapeFunction2Line<T>::N(Vector<T> _r){
	...
	template<class T>
	Matrix<T> ShapeFunction2Line<T>::dNdr(Vector<T> _r){
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction3Line<T>::N(Vector<T> _r){
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction3Line<T>::dNdr(Vector<T> _r){
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction3Triangle<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
		N(0) = _r(0);
		N(1) = _r(1);
		N(2) = 1.0 - _r(0) - _r(1);
	...
	template<class T>
	Matrix<T> ShapeFunction3Triangle<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction6Triangle<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction6Triangle<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction4Square<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction4Square<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction8Square<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction8Square<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction4Tetrahedron<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
		N(0) = _r(0);
		N(1) = _r(1);
		N(2) = _r(2);
	...
	template<class T>
	Matrix<T> ShapeFunction4Tetrahedron<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction8Cubic<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction8Cubic<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
...
public:
	...
	template<class T>
	Vector<T> ShapeFunction20Cubic<T>::N(Vector<T> _r) {
		Vector<T> N = Vector<T>(n);
	...
	template<class T>
	Matrix<T> ShapeFunction20Cubic<T>::dNdr(Vector<T> _r) {
		Matrix<T> dNdr = Matrix<T>(d, n);
