//*****************************************************************************
//Title		:PANSFEM2/FEM/Controller/ShapeFunction.h
//Author	:Tanabe Yuta
//Date		:2019/10/12
...
namespace PANSFEM2 {
	...
	template<class T>
	std::vector<std::vector<T> > dNdr20I3(std::vector<T>& _r) {
		std::vector<std::vector<T> > dNdr = std::vector<std::vector<T> >(3, std::vector<T>(8));
