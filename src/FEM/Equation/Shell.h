	...
	void ShellLinearIsotropicElastic2(Matrix<T>& _Ke, std::vector<std::vector<std::pair<int, int> > >& _nodetoelement, const std::vector<int>& _element, const std::vector<int>& _doulist, std::vector<Vector<T> >& _x, T _E, T _V, T _t) {
		...
		for (int g = 0; g < IC01<T>::N; g++) {
            for(int h = 0; h < IC2<T>::N; h++){
                ...
                for(int i = 0; i < _element.size(); i++){
                    B(0, 6*i) = dNdx(0, i); B(0, 6*i + 1) = T();        B(0, 6*i + 2) = T();        B(0, 6*i + 3) = 0.5*_t*dNzdx(0, i)*v1(i, 0)*v1(i, 0) - 0.5*_t*dNzdx(0, i)*v2(i, 0)*v2(i, 0);                                                    B(0, 6*i + 4) = 0.5*_t*dNzdx(0, i)*v1(i, 0)*v1(i, 1) - 0.5*_t*dNzdx(0, i)*v2(i, 0)*v2(i, 1);                                                    B(0, 6*i + 5) = 0.5*_t*dNzdx(0, i)*v1(i, 0)*v1(i, 2) - 0.5*_t*dNzdx(0, i)*v2(i, 0)*v2(i, 2);
                    B(1, 6*i) = T();        B(1, 6*i + 1) = dNdx(1, i); B(1, 6*i + 2) = T();        B(1, 6*i + 3) = 0.5*_t*dNzdx(1, i)*v1(i, 1)*v1(i, 0) - 0.5*_t*dNzdx(1, i)*v2(i, 1)*v2(i, 0);                                                    B(1, 6*i + 4) = 0.5*_t*dNzdx(1, i)*v1(i, 1)*v1(i, 1) - 0.5*_t*dNzdx(1, i)*v2(i, 1)*v2(i, 1);                                                    B(1, 6*i + 5) = 0.5*_t*dNzdx(1, i)*v1(i, 1)*v1(i, 2) - 0.5*_t*dNzdx(1, i)*v2(i, 1)*v2(i, 2);
                    B(2, 6*i) = T();        B(2, 6*i + 1) = T();        B(2, 6*i + 2) = dNdx(2, i); B(2, 6*i + 3) = 0.5*_t*dNzdx(2, i)*v1(i, 2)*v1(i, 0) - 0.5*_t*dNzdx(2, i)*v2(i, 2)*v2(i, 0);                                                    B(2, 6*i + 4) = 0.5*_t*dNzdx(2, i)*v1(i, 2)*v1(i, 1) - 0.5*_t*dNzdx(2, i)*v2(i, 2)*v2(i, 1);                                                    B(2, 6*i + 5) = 0.5*_t*dNzdx(2, i)*v1(i, 2)*v1(i, 2) - 0.5*_t*dNzdx(2, i)*v2(i, 2)*v2(i, 2);
                    B(3, 6*i) = dNdx(1, i); B(3, 6*i + 1) = dNdx(0, i); B(3, 6*i + 2) = T();        B(3, 6*i + 3) = 0.5*_t*(dNzdx(1, i)*v1(i, 0) + dNzdx(0, i)*v1(i, 1))*v1(i, 0) - 0.5*_t*(dNzdx(1, i)*v2(i, 0) + dNzdx(0, i)*v2(i, 1))*v2(i, 0);  B(3, 6*i + 4) = 0.5*_t*(dNzdx(1, i)*v1(i, 0) + dNzdx(0, i)*v1(i, 1))*v1(i, 1) - 0.5*_t*(dNzdx(1, i)*v2(i, 0) + dNzdx(0, i)*v2(i, 1))*v2(i, 1);  B(3, 6*i + 5) = 0.5*_t*(dNzdx(1, i)*v1(i, 0) + dNzdx(0, i)*v1(i, 1))*v1(i, 2) - 0.5*_t*(dNzdx(1, i)*v2(i, 0) + dNzdx(0, i)*v2(i, 1))*v2(i, 2);
                    B(4, 6*i) = dNdx(2, i); B(4, 6*i + 1) = T();        B(4, 6*i + 2) = dNdx(0, i); B(4, 6*i + 3) = 0.5*_t*(dNzdx(0, i)*v1(i, 2) + dNzdx(2, i)*v1(i, 0))*v1(i, 0) - 0.5*_t*(dNzdx(0, i)*v2(i, 2) + dNzdx(2, i)*v2(i, 0))*v2(i, 0);  B(4, 6*i + 4) = 0.5*_t*(dNzdx(0, i)*v1(i, 2) + dNzdx(2, i)*v1(i, 0))*v1(i, 1) - 0.5*_t*(dNzdx(0, i)*v2(i, 2) + dNzdx(2, i)*v2(i, 0))*v2(i, 1);  B(4, 6*i + 5) = 0.5*_t*(dNzdx(0, i)*v1(i, 2) + dNzdx(2, i)*v1(i, 0))*v1(i, 2) - 0.5*_t*(dNzdx(0, i)*v2(i, 2) + dNzdx(2, i)*v2(i, 0))*v2(i, 2);
                    B(5, 6*i) = T();        B(5, 6*i + 1) = dNdx(2, i); B(5, 6*i + 2) = dNdx(1, i); B(5, 6*i + 3) = 0.5*_t*(dNzdx(2, i)*v1(i, 1) + dNzdx(1, i)*v1(i, 2))*v1(i, 0) - 0.5*_t*(dNzdx(2, i)*v2(i, 1) + dNzdx(1, i)*v2(i, 2))*v2(i, 0);  B(5, 6*i + 4) = 0.5*_t*(dNzdx(2, i)*v1(i, 1) + dNzdx(1, i)*v1(i, 2))*v1(i, 1) - 0.5*_t*(dNzdx(2, i)*v2(i, 1) + dNzdx(1, i)*v2(i, 2))*v2(i, 1);  B(5, 6*i + 5) = 0.5*_t*(dNzdx(2, i)*v1(i, 1) + dNzdx(1, i)*v1(i, 2))*v1(i, 2) - 0.5*_t*(dNzdx(2, i)*v2(i, 1) + dNzdx(1, i)*v2(i, 2))*v2(i, 2);
                }
